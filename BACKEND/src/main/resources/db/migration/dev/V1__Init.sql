...
(
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT ` fk_job_offer_user_id ` FOREIGN KEY
(
    `employer_id`
) REFERENCES ` user `
(
...
(
    ...
    KEY ` fk_job_offer_category_category_id `
(
    `category_id`
),
    CONSTRAINT ` fk_job_offer_category_category_id ` FOREIGN KEY
(
    `category_id`
) REFERENCES ` category `
(
    ...
    CONSTRAINT ` fk_job_offer_category_job_offer_id ` FOREIGN KEY
(
    `job_offer_id`
...
(
    ...
    KEY ` fk_job_offer_technology_technology_id `
(
    `technology_id`
),
    CONSTRAINT ` fk_job_offer_technology_technology_id ` FOREIGN KEY
(
    `technology_id`
...
(
    ...
    CONSTRAINT ` fk_job_offer_technology_job_offer_id ` FOREIGN KEY
(
    `job_offer_id`
) REFERENCES ` job_offer `
(
...
(
    ...
    KEY ` fk_job_offer_seniority_seniority_id `
(
    `seniority_id`
),
    CONSTRAINT ` fk_job_offer_seniority_seniority_id ` FOREIGN KEY
(
    `seniority_id`
...
(
    ...
    CONSTRAINT ` fk_job_offer_seniority_job_offer_id ` FOREIGN KEY
(
    `job_offer_id`
) REFERENCES ` job_offer `
(
...
(
    ...
    KEY ` fk_job_offer_location_location_id `
(
    `location_id`
),
    CONSTRAINT ` fk_job_offer_location_location_id ` FOREIGN KEY
(
    `location_id`
) REFERENCES ` location `
(
    ...
    CONSTRAINT ` fk_job_offer_location_job_offer_id ` FOREIGN KEY
(
    `job_offer_id`
) REFERENCES ` job_offer `
(
...
(
    ...
    KEY ` fk_job_offer_benefit_benefit_id `
(
    `benefit_id`
),
    CONSTRAINT ` fk_job_offer_benefit_benefit_id ` FOREIGN KEY
(
    `benefit_id`
) REFERENCES ` benefit `
(
    ...
    CONSTRAINT ` fk_job_offer_benefit_job_offer_id ` FOREIGN KEY
(
    `job_offer_id`
) REFERENCES ` job_offer `
(
